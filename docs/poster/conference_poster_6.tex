...
accepted targets by count and weight.

\begin{center}
  \includegraphics[width=\linewidth,height=18cm,keepaspectratio]{model2image.png}
  \captionof{figure}{Sources and weighted targets define a network-distance classification problem.}
\end{center}
...
supports walking, driving and cycling by changing only the OSRM profile.
